...
public class EmpoweredStrike : Card, ITargetSingleEnemy
{
    ...
    public void ReceiveSingleEnemyTarget(GameObject receivedTarget)
    {
        ...
        else
        {
            ...
            currentProcessor.GetComponent<InterjectionProcessor>().startingValue = damage + (cardsPlayedThisTurn * damagePerCard); // Damage is added by the number of cards you played this turn
